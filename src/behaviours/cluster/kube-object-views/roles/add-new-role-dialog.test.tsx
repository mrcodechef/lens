...
describe("Roles view/add new role dialog", () => {
  ...
  beforeEach(async () => {
    ...
    applicationBuilder.beforeRender(() => {
      rendererDi.override(namespacesInjectable, () => computed(() => (
        ["default", "my-namespace", "my-namespace-2"]
      )));

      rendererDi.inject(roleStoreInjectable).create = createRoleMock;

      rendererDi.override(showDetailsInjectable, () => showDetailsMock);
    ...
    const navigateToRolesView = rendererDi.inject(navigateToRolesViewInjectable);
